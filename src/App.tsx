...
import { ShieldCheck, ChevronLeft, Sun, Moon, Award, LogOut, Key, CheckCircle, Shield } from 'lucide-react';
        ...
        <div className="flex items-center gap-3">
          ...
          {user ? (
            ...
            <button
              ...
              className="text-xs text-sky-400 hover:text-sky-300 transition-all font-mono font-semibold flex items-center gap-1.5 bg-slate-900 border border-sky-500/30 px-3 py-1.5 rounded-xl cursor-pointer"
            >
